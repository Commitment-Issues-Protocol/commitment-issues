...
import { AGENTKIT, buildAgentkitSchema, createAgentkitClient, } from '@worldcoin/agentkit';
 ...
 */
function buildExtension(resourceUri) {
    return {
        info: {
 ...
 */
function createAgentkitAuth(privateKey) {
    if (!privateKey) {
