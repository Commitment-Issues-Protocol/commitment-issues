 ...
 */
const SIGNING_KEY = 'ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIN+RPgXXP6WXhg/EIuhsicEyqVXpffCBqSidkVhpSSLc';
/**
 ...
 * author identity untouched
 */
const COMMITTER_EMAIL = '309237263+commitment-issues-protocol-author@users.noreply.github.com';
/**
 ...
 */
function writeAgentWalletPrivateKey(privateKey) {
    mkdirSync(dirname(WALLET_KEY_PATH), { recursive: true, mode: 0o700 });
    writeFileSync(WALLET_KEY_PATH, `${privateKey}\n`, { mode: 0o600 });
}
export { API_URL, COMMITTER_EMAIL, COMMITTER_NAME, FINGERPRINT, getAgentWalletPrivateKey, SIGNING_KEY, SOCKET_PATH, WALLET_KEY_PATH, writeAgentWalletPrivateKey, };
